...
property :repositoryid, String, default: 'elrepo-kernel'
property :mirrorlist, String, default: lazy { yum_elrepo_mirrorlist('elrepo-kernel') }
property :description, String, default: lazy { yum_elrepo_description('Community Enterprise Linux Kernel') }
