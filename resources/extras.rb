...
property :repositoryid, String, default: 'elrepo-extras'
property :mirrorlist, String, default: lazy { yum_elrepo_mirrorlist('elrepo-extras') }
property :description, String, default: lazy { yum_elrepo_description('Community Enterprise Linux Extras') }
