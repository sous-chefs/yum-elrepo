...
property :repositoryid, String, default: 'elrepo'
property :mirrorlist, String, default: lazy { yum_elrepo_mirrorlist('elrepo') }
property :description, String, default: lazy { yum_elrepo_description('Community Enterprise Linux') }
